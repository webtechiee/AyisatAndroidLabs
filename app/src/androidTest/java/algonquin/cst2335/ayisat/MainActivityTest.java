...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTextText2), withText("Type password"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Type pass"));

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextText2), withText("Type pass"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editTextText2), withText("12345"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
